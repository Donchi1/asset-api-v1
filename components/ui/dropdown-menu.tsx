...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border-none shadow-sm shadow-primary-gray/20 bg-sidebar p-1 text-primary-gray  dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50",
